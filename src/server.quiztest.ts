...
describe('Testing POST /v1/admin/quiz/{quizid}/question', () => {
    ...
    describe('Testing: Error cases', () => {
        // Incorrect values
        const shortQuestion: string = 'a';
        const longQuestion: string = '123456789 123456789 123456789 123456789 123456789 123456789';
        const negativeDuration: number = -1; 
        const smallPoints: number = 0;
        const largePoints: number = 11;
