...
describe('Testing GET /v1/admin/quiz/{quizid}/session/{sessionid}/results', () => {
    ...
    beforeEach(() => {
      ...
      // Simulate a completed quiz session
      // Simulate the quiz session entering the FINAL_RESULTS state
      // Add necessary data to mock the final results
      // This can vary based on your implementation
      // For the purpose of this example, we will simply use some dummy data
      // Replace this with actual data relevant to your application
      simulateQuizSessionCompletion(quiz.quizId, session.sessionId);
    });
